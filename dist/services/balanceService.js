...
exports.balanceCalculus = void 0;
...
function balanceCalculus(cardId) {
    return __awaiter(this, void 0, void 0, function () {
        var valid, active, payments, recharges, totalRecharges, totalPayments, balance, objReturn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, paymentRepository_1.findPaymentByCardId)(cardId)];
                case 3:
                    payments = _a.sent();
                    return [4 /*yield*/, (0, rechargeRepository_1.findRechargeByCardId)(cardId)];
                case 4:
                    recharges = _a.sent();
                    totalRecharges = amountSum(recharges);
                    totalPayments = amountSum(payments);
...
exports.balanceCalculus = balanceCalculus;
function amountSum(array) {
    var sum = 0;
