...
exports.changingCardStatus = exports.activatingCard = void 0;
var validCardService_1 = require("./validCardService");
var cardRepository_1 = require("../repositories/cardRepository");
function activatingCard(id, password, cvc) {
    return __awaiter(this, void 0, void 0, function () {
        var valid, active, cardData, updateData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, validCardService_1.isValid)(id)];
                case 1:
                    valid = _a.sent();
                    if (!valid) {
                        throw { code: 'Not Valid', message: 'Card not valid' };
                    }
                    return [4 /*yield*/, (0, validCardService_1.isActive)(id)];
                case 2:
                    active = _a.sent();
                    if (!active) {
                        throw { code: 'Not Valid', message: 'Card not active' };
                    }
                    return [4 /*yield*/, (0, cardRepository_1.findById)(id)];
                case 3:
                    cardData = _a.sent();
                    ...
                    return [4 /*yield*/, (0, cardRepository_1.update)(id, updateData)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports.activatingCard = activatingCard;
function changingCardStatus(id, password, newStatus) {
    return __awaiter(this, void 0, void 0, function () {
        var valid, active, cardData, updateData;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.changingCardStatus = changingCardStatus;
